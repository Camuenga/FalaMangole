...
namespace {
struct qt_meta_tag_ZN11falamangoleE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN11falamangoleE = QtMocHelpers::stringData(
    "falamangole",
...
Q_CONSTINIT static const uint qt_meta_data_ZN11falamangoleE[] = {
...
Q_CONSTINIT const QMetaObject falamangole::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN11falamangoleE.offsetsAndSizes,
    qt_meta_data_ZN11falamangoleE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN11falamangoleE_t,
        // Q_OBJECT / Q_GADGET
...
void *falamangole::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN11falamangoleE.stringdata0))
